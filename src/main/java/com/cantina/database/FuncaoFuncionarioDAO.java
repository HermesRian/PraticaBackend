...
public class FuncaoFuncionarioDAO {
    ...
    public void salvar(FuncaoFuncionario funcaoFuncionario) {
        String sql = "INSERT INTO funcoes_funcionarios (descricao, status, nome, requer_cnh, carga_horaria, observacao, user_criacao, user_atualizacao, created_at, updated_at) " +
                     "VALUES (?, ?, ?, ?, ?, ?, ?, ?, NOW(), NOW())";
    ...
    public List<FuncaoFuncionario> listarTodos() {
        ...
        String sql = "SELECT * FROM funcoes_funcionarios";
    ...
    public FuncaoFuncionario buscarPorId(Long id) {
        String sql = "SELECT * FROM funcoes_funcionarios WHERE id = ?";
    ...
    public void atualizar(FuncaoFuncionario funcaoFuncionario) {
        String sql = "UPDATE funcoes_funcionarios SET descricao = ?, status = ?, nome = ?, requer_cnh = ?, carga_horaria = ?, observacao = ?, user_atualizacao = ?, updated_at = NOW() WHERE id = ?";
    ...
    public void excluir(Long id) {
        String sql = "DELETE FROM funcoes_funcionarios WHERE id = ?";
    ...
    public List<FuncaoFuncionario> listarAtivos() {
        List<FuncaoFuncionario> funcoes = new ArrayList<>();
        String sql = "SELECT * FROM funcoes_funcionarios WHERE status = true";
